  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Investigando accidentes de tránsito
        p.mb-4 Afianzar los conocimientos y habilidades para la investigación de accidentes de tránsito y las actuaciones de policía judicial, con base en los contenidos del componente formativo.
